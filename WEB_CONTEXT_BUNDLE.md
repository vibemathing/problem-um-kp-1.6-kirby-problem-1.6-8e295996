...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.6-kirby-problem-1.6-8e295996-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.6"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.6-kirby-problem-1.6-8e295996-v1",
      "problem_contract_sha256": "cafd2390ca9d47f5b9f525d5a7d62811717e0da007d45a1bbabf9552d87ef1d6",
      "problem_id": "problem:um-kp-1.6-kirby-problem-1.6-8e295996",
      "route_id": "route:um-kp-1.6-kirby-problem-1.6-8e295996-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.6-kirby-problem-1.6-8e295996-source-fidelity-01",
      "graph_id": "graph:um-kp-1.6-kirby-problem-1.6-8e295996-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.6-kirby-problem-1.6-8e295996-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.6-kirby-problem-1.6-8e295996-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose that $V_{1}$ and $V_{2}$ are $S$–equivalent Seifert forms. Does there exist a fixed knot $K$ bounding Seifert surfaces $F_{1}$ and $F_{2}$ for which the as- sociated Seifert forms are $V_{1}$ and $V_{2}$?"
          },
          "statement_sha256": "25d3c21ef60a900137c92f318ab79b13a8dee9655b2fdeb2c753a7bb69b75d95"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.6-kirby-problem-1.6-8e295996-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.6-kirby-problem-1.6-8e295996-root",
      "route_id": "route:um-kp-1.6-kirby-problem-1.6-8e295996-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.6-ca9d6689c461",
        "url": "https://www.unsolvedmath.com/problems/KP-1.6"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
